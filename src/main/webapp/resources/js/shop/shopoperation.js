$(function() {
	...
	// 获取基本信息的URL
	var initUrl =  '/o2o-1/shopadmin/getshopinitinfo';
	// 注册店铺的URL
	var registerShopUrl = '/o2o-1/shopadmin/registshop';
	// 通过shopId获取商铺信息的URL
	var getShopInfoByShopId ='/o2o-1/shopadmin/getshopbyid?shopId=' + shopId;
	// 修改商铺的URL
	var modifyShopUrl = '/o2o-1/shopadmin/modifyshop';
