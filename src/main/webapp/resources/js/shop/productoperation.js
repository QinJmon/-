$(function(){
    ...
    var infoUrl = '/o2o-1/shopadmin/getproductbyid?productId=' + productId;
    //获取当前店铺设定的商品类别列表的URL
    var categoryUrl = '/o2o-1/shopadmin/getproductcategorylist';
    //更新商品信息的URL
    var productPostUrl = '/o2o-1/shopadmin/modifyproduct';
    ...
    if(productId){
        ...
        getCategory();
        productPostUrl = "/o2o-1/shopadmin/addproduct";
    }
